package com.example.lab12_authentication_email;
...
public class MainActivity extends AppCompatActivity {
    ...
    // As firebase suggested, the password must be 6 chars above.
    // Firebase would not assign if the account alr existed.

    private void signUpUser(String email, String password) {
        // When user created -> run the other task (email verification).
